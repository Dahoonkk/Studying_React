    ...
    <section name="home" className="flex w-full h-screen bg-zinc-200">
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center w-full px-2 py-8 md:item-start">
          <p className="text-2xl">User our chat platform.</p>
        ...
        <div className="flex flex-col justify-center px-2">
          <h2 className="font-semimbold xs:text-[48px] text-[40px] xs:leading-[76.8px] leading-[66.8px] w-full">
            Easily download app <br className="hidden sm:block" /> Google &
            Apple
          </h2>
          <p className={`text-[18px] leading-[30.8px] max-w-[470px] mt-5`}>
            Elit enim sed massa etiam. Marius eu adipiscing ultrices ametodio
